...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 30 15:58:28 2021
   
@author: xavier_wong
"""

#######导入模块
##这个库是为了在老版本的python中兼顾新特性的一种方法
...
def loadConversations(fileName,lines,fields):
    ...
    with open(fileName,"r",encoding = "iso-8859-1") as f:
        for line in f:
            ...
            lineIds = eval(conv0bj["utteranceIDs"])
            conv0bj["lines"] = []
...
##将调用这些函数来创建文件，我们命名为formatted_movie_lines.txt。
# 定义新文件的路径
...
####加载和清洗数据，数据预处理
# 默认词向量
# 会存储从单词到索引的映射、索引到单词的反向映射、每个单词的计数和总单词量
